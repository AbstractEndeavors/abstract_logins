#/flask_app/login_app/endpoints/files/share_utils.py
from ....imports import *
secure_shares_bp,logger = get_bp('secure_shares_bp', __name__,
                                 url_prefix=URL_PREFIX,
                                 static_folder = STATIC_FOLDER)
@secure_shares_bp.route('/files/<int:file_id>/share', methods=['PATCH'])
@login_required
...
@secure_shares_bp.route('/files/<int:file_id>/share-link', methods=['GET','POST'])
@login_required
